...
namespace GhabzeTo.Infra.Data.EF.Config
{
    public static class EFDatabaseProviders
    {
        /// <summary>
            ...
            SiteSettings siteSettings)
        {
            switch (siteSettings.ActiveDatabase)
            {
                ...
                case ActiveDatabase.PostgreSQL:
                    optionsBuilder.UseNpgsql(siteSettings.GetDbConnectionString());
                    break;
        ...
        public static string GetDbConnectionString(this SiteSettings siteSettingsValue)
        {
            ...
            switch (siteSettingsValue.ActiveDatabase)
            {
                ...
                case ActiveDatabase.PostgreSQL:
                    return siteSettingsValue.ConnectionStrings.PostgreSQL.ApplicationDbContextConnection;
